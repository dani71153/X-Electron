...
contextBridge.exposeInMainWorld('api', {
  ...
  almacenamiento: () => ipcRenderer.invoke(CANALES.ALMACENAMIENTO_RESUMEN),
  limpiarPublicaciones: (dias) => ipcRenderer.invoke(CANALES.ALMACENAMIENTO_LIMPIAR, dias),
  ...
  estadisticasBiblioteca: () => ipcRenderer.invoke(CANALES.ESTADISTICAS_BIBLIOTECA),
  estadisticasSistema: () => ipcRenderer.invoke(CANALES.ESTADISTICAS_SISTEMA),
